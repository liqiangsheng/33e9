...
<p style="width:100%;height:4px;background:#ccc"></p>
...
<p style="color:red">REC_VIDEO	3	录制视频(内容由setRecordVideos设定);用户可以自由组合，如REC_AUDIO_LOC|REC_VIDEO，表示录制本地语音和视频；
REC_AUDIO_LOC|REC_AUDIO_OTHER，录制双方语音</p>
...
| HTTPR_HTTPERR_END	|1999|	http错误码结束	 |
 <p style="color:red">如HTTP_TRANSFER_RESULT=1404，则表示http返回了404；</p>
